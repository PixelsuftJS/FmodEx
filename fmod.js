...
push_export({
  ...
  'FMOD_Thread_SetAttributes': ['int', ['int', 'long', 'int', 'Uint']],
  ...
  'FMOD_System_GetFileUsage': ['int', ['void*', 'long*', 'long*', 'long*']],
  ...
  'FMOD_System_AttachChannelGroupToPort': ['int', ['void*', 'int', 'Ulong', 'void*', 'int']],
  ...
  'FMOD_Channel_GetDSPClock': ['int', ['void*', 'Ulong*', 'Ulong*']],
  'FMOD_Channel_SetDelay': ['int', ['void*', 'Ulong', 'Ulong', 'int']],
  'FMOD_Channel_GetDelay': ['int', ['void*', 'Ulong*', 'Ulong*', 'int*']],
  'FMOD_Channel_AddFadePoint': ['int', ['void*', 'Ulong', 'float']],
  'FMOD_Channel_SetFadePointRamp': ['int', ['void*', 'Ulong', 'float']],
  'FMOD_Channel_RemoveFadePoints': ['int', ['void*', 'Ulong', 'Ulong']],
  'FMOD_Channel_GetFadePoints': ['int', ['void*', 'Uint*', 'Ulong*', 'float*']],
  ...
  'FMOD_ChannelGroup_GetDSPClock': ['int', ['void*', 'Ulong*', 'Ulong*']],
  'FMOD_ChannelGroup_SetDelay': ['int', ['void*', 'Ulong', 'Ulong', 'int']],
  'FMOD_ChannelGroup_GetDelay': ['int', ['void*', 'Ulong*', 'Ulong*', 'int*']],
  'FMOD_ChannelGroup_AddFadePoint': ['int', ['void*', 'Ulong', 'float']],
  'FMOD_ChannelGroup_SetFadePointRamp': ['int', ['void*', 'Ulong', 'float']],
  'FMOD_ChannelGroup_RemoveFadePoints': ['int', ['void*', 'Ulong', 'Ulong']],
  'FMOD_ChannelGroup_GetFadePoints': ['int', ['void*', 'Uint*', 'Ulong*', 'float*']],
