...
e.FMOD_ErrorString = function(errcode) {
  switch (errcode) {
    case e.FMOD_OK:
      return "No errors.";
    case e.FMOD_ERR_BADCOMMAND:
    ...
    case e.FMOD_ERR_CHANNEL_ALLOC:
      return "Error trying to allocate a channel.";
    case e.FMOD_ERR_CHANNEL_STOLEN:
    ...
    case e.FMOD_ERR_DSP_CONNECTION:
    ...
    case e.FMOD_ERR_DSP_DONTPROCESS:
    ...
    case e.FMOD_ERR_SUBSOUND_ALLOCATED:
    ...
    case e.FMOD_ERR_SUBSOUND_CANTMOVE:
